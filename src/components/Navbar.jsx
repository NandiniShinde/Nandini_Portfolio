      ...
      <Container>
        ...
        >
          <span className="text-primary">
            <Typewriter
              words={['Nandini', 'Nandini.codes()', 'Data Engineer']}
              loop={0}
              cursor
              cursorStyle="|"
              typeSpeed={110}
        ...
        <BootstrapNavbar.Collapse id="basic-navbar-nav">
          <Nav className="ms-auto align-items-center">
            ...
            <a href="https://github.com/NandiniShinde" target="_blank" rel="noopener noreferrer" className="nav-link px-2">
              <FaGithub size={22} />
            </a>
            <a href="https://www.linkedin.com/in/nandini-shinde-b7b694208/" target="_blank" rel="noopener noreferrer" className="nav-link px-2">
              <FaLinkedin size={22} />
            </a>
            <OverlayTrigger
              placement="bottom"
